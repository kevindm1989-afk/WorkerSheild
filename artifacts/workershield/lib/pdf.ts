...
function buildHtml(args: PdfArgs): string {
  ...
  return `<!doctype html><html><head><meta charset="utf-8"><title>WorkerShield Response</title>
<style>
  @page { margin: 0.6in; }
  * { box-sizing: border-box; }
  ...
  .tagline { font-size: 8pt; letter-spacing: 1.4pt; color: #57606D; margin-top: 4px; text-transform: uppercase; }
  ...
  <div class="header">
    ...
    <div class="tagline">Ontario Labour Defense Response — ${date}</div>
  </div>
  <div class="meta">
  ...
  <div class="footer">Generated by WorkerShield · This is an AI-generated analysis · Verify with your union representative before taking action</div>
</body></html>`;
}
...
export async function exportFinalAsPdf(args: PdfArgs): Promise<void> {
  ...
  if (await Sharing.isAvailableAsync()) {
    await Sharing.shareAsync(uri, {
      ...
      dialogTitle: "WorkerShield Response",
      UTI: "com.adobe.pdf",
    });
  }
}
